package com.panda.sakya.plugin;
...
public class PluginContext extends LayoutInflaterProxyContext {
    ...
    public Object getSystemService(String name) {
        if (name.equals(Constant.GET_HOST_CONTEXT)) {
            return super.getBaseContext();
        }else if (name.equals(Constant.GET_HOST_RESOURCE)) {
            return plugInfo.getResources();
        }else if (name.equals(Constant.GET_HOST_ASSETS)) {
            return plugInfo.getAssets();
        }else if (name.equals(Constant.GET_HOST_CLASS_LOADER)) {
            return plugInfo.getClassLoader();
        }else if (name.equals(Constant.GET_PLUGIN_PATH)) {
            return plugInfo.getFilePath();
        }else if (name.equals(Constant.GET_PLUGIN_PKG_NAME)) {
            return plugInfo.getPackageName();
        }else if (name.equals(Constant.GET_PLUGIN_PKG_INFO)) {
